...
public class Quiz {
	...
	{
	Questions q1 = new Questions("If I make a variable static, can I change its value in Java?", "A. Yes, but only within static methods. ", "B. Yes, but it can only be changed once during the class's lifetime ", "C. Yes, it can be changed from any method in the class ", "D. Both A & C");
	Questions q2 = new Questions("Which of the following is the correct way to handle exceptions in Java?", "A.try-catch. ", "B. try-except. ","C. catch-finally. ","D. try-catch-finally");
